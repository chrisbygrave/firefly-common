...
var (
	...
	MsgCannotUseRouteAndVersionedAPI               = ffe("FF00251", "Cannot use both Routes and VersionedAPIs to initialize the API Server")
	MsgMissingVersionedAPI                         = ffe("FF00252", "No API versions found in VersionedAPIs")
